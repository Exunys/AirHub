...
local Visuals = {
    ...
    AddESP = function(Player)
        ...
        PlayerTable.Connections.ESP = RunService.RenderStepped:Connect(function()
            if Player.Character and Player.Character.Humanoid and Player.Character.HumanoidRootPart and Player.Character.Head and Environment.Settings.Enabled then
    ...
    AddTracer = function(Player)
        ...
        PlayerTable.Connections.Tracer = RunService.RenderStepped:Connect(function()
            if Player.Character and Player.Character.Humanoid and Player.Character.HumanoidRootPart and Environment.Settings.Enabled then
    ...
    AddHeadDot = function(Player)
        ...
        PlayerTable.Connections.HeadDot = RunService.RenderStepped:Connect(function()
            if Player.Character and Player.Character.Humanoid and Player.Character.Head and Environment.Settings.Enabled then
                local Vector, OnScreen = WorldToViewportPoint(Player.Character.Head.Position)
    ...
    AddCrosshair = function()
        ...
        ServiceConnections.AxisConnection, ServiceConnections.CrosshairConnection = RunService.RenderStepped:Connect(function()
            ...
            Environment.Crosshair.Parts.LeftLine.From = Vector2new(AxisX + (Environment.Crosshair.Settings.GapSize or 5), AxisY)
            Environment.Crosshair.Parts.LeftLine.To = Vector2new(AxisX + (Environment.Crosshair.Settings.Size or 12), AxisY)
...
local function Load()
    ...
    ServiceConnections.ReWrapPlayers = RunService.RenderStepped:Connect(function(v)
