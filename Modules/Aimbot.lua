...
local select = select
local pcall, getgenv, next, setmetatable, Vector2new, CFramenew, Color3fromRGB, mathclamp, type, mousemoverel = select(1, pcall, getgenv, next, setmetatable, Vector2new.new, CFramenew, Color3.fromRGB, math.clamp, type, mousemoverel or (Input and Input.MouseMove))
